...
// Google Sheets setup
const GOOGLE_SHEET_ID = '10meH9FPNeqhZXHvJzbiDmbr-_KsEGUsHcAdOM0Ghwqo';
...
export async function POST(request) {
  try {
    ...
    await transporter.sendMail({
      from: '"Rahul Nagar BMS" <rahulnagarassociation1@gmail.com>',
      to: 'rahulnagarassociation1@gmail.com',
      subject: 'New Inquiry Received - Rahul Nagar Building Management',
      html: `<!DOCTYPE html>
      <html lang="en">
      <head>
          <meta charset="UTF-8">
