...
const BuildingPage = () => {
    ...
    if (!building) return <p className='text-center'>Loading...</p>;

    return (
        <div className='w-full min-h-screen'>
            <ServiceHeroSection
                name={building.name || `Project ${id}`}
                    ...
                    <div className='w-full px-6 md:px-12'>
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                            <div className='md:col-span-2'>
                                ...
                                <h2 className='text-2xl font-bold mt-6'>About {building.name}</h2>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                                {building.owners?.map((owner, index) => (
                                    <div key={index} className="bg-white shadow-md rounded-lg p-4 flex items-center space-x-4">
                                        <img src={owner.image || "/icon.png"} alt="Resident Icon" className="w-12 h-12" />
                                        <div>
