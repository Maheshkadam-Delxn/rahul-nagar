...
{/* 3 cards for for each chairmen , secratery and then treasurer */}
    ...
    <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
                { title: "Chairman", name: building.president, image: "/avatar.jpg" },
                { title: "Secretary", name: building.secretary, image: "/avatar.jpg" },
                { title: "Treasurer", name: building.treasurer, image: "/avatar.jpg" },
            ].map((role, index) => (
