          ...
          {upcomingEvents.length > 0 && (
            <div className="flex flex-col items-start gap-5 w-full">
              <div className="flex items-center gap-4">
                ...
                />
                <h1 className="text-lg font-semibold text-[#B57E10]">
                  Upcoming Events
                </h1>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 w-full">
                {upcomingEvents.map((event, index) => (
                  <div
                    key={index}
                    className="rounded-lg p-5 transition duration-300 border border-gray-200"
                  >
                    ...
                    <p className="text-[#B57E10] mt-2 font-medium">
                      {formatDateTime(event.date, 'Asia/Kolkata')}
                    </p>
            ...
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  {
                    title: "Chairman",
                    name: building.president,
                    image: getImageSrc(building.presidentImage),
                  },
                  {
                    title: "Secretary",
                    name: building.secretary,
                    image: getImageSrc(building.secretaryImage),
                  },
                  {
                    title: "Treasurer",
                    name: building.treasurer,
                    image: getImageSrc(building.treasurerImage),
                  },
                ].map((role, index) => (
                  <div
                    key={index}
              ...
              <div className="max-w-6xl w-full px-6 md:px-12 flex flex-col items-start gap-14">
                <div className="flex flex-col items-start gap-2">
                  <h2 className="text-2xl font-bold">
                    Flat / Shop Owners of {building.name}
                  </h2>
